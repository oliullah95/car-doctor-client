        ...
        <div className="hero mt-20 bg-base-200 ">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='lg:w-1/2 p-4'>
                    ...
                    <p className="py-6 space-y ">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which do not look even slightly believable. </p>
